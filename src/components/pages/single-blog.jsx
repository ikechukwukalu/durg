...
class SingleBlog extends Component {
  ...
  render() {
    return (
        <Fragment>
            <Banner text="Blog Single"  name="Blog Single"/>
                    ...
                    <div className="row">
                        ...
                        <div className="single-post">
                            <div className="feature-img">
                                <img className="img-fluid" src={this.state. base_url+"assets/images/blog/single_blog_1.png"} alt="" />
                            </div>
                        ...
                        <div className="navigation-top">
                            ...
                            <div className="navigation-area">
                                <div className="row">
                                    ...
                                    <div className="thumb">
                                        <Link to="single-blog">
                                            <img className="img-fluid" src={this.state. base_url+"assets/images/post/preview.png"} alt="" />
                                        </Link>
                                    </div>
                                    <div className="arrow">
                                        <Link to="single-blog">
                                    ...
                                    <div className="thumb">
                                        <Link to="single-blog">
                                            <img className="img-fluid" src={this.state. base_url+"assets/images/post/next.png"} alt="" />
                                        </Link>
                                    </div>
                                    </div>
                                </div>
                        ...
                        <div className="blog-author">
                            <div className="media align-items-center">
                                <img src={this.state. base_url+"assets/images/blog/author.png"} alt="" />
                        ...
                        <div className="comments-area">
                            ...
                            <div className="comment-list">
                                <div className="single-comment justify-content-between d-flex">
                                    ...
                                    <div className="thumb">
                                        <img src={this.state. base_url+"assets/images/comment/comment_1.png"} alt="" />
                                    </div>
                                    <div className="desc">
                                        <p className="comment">
                                        ...
                                        <div className="d-flex justify-content-between">
                                            <div className="d-flex align-items-center">
                                                <h5>
                                                <Link to="single-blog">Emilly Blunt</Link>
                                                </h5>
                            ...
                            <div className="comment-list">
                                <div className="single-comment justify-content-between d-flex">
                                    <div className="user justify-content-between d-flex">
                                    <div className="thumb">
                                        <img src={this.state. base_url+"assets/images/comment/comment_2.png"} alt="" />
                                    </div>
                                    <div className="desc">
                                        <p className="comment">
                                            Multiply sea night grass fourth day sea lesser rule open subdue female fill which them
                            ...
                            <div className="comment-list">
                                <div className="single-comment justify-content-between d-flex">
                                    <div className="user justify-content-between d-flex">
                                    <div className="thumb">
                                        <img src={this.state. base_url+"assets/images/comment/comment_3.png"} alt="" />
                                    </div>
                                    <div className="desc">
                                        <p className="comment">
                                            Multiply sea night grass fourth day sea lesser rule open subdue female fill which them
