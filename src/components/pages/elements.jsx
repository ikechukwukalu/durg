...
class Elements extends Component {
  ...
  render() {
    return (
        <Fragment>
            <Banner text="Elements"  name="Elements"/>
            ...
            <section className="button-area">
                <div className="container box_1170 border-top-generic">
                    ...
                    <div className="button-group-area mt-40">
                        <a href="#" className="genric-btn default circle">Default<span className="lnr lnr-arrow-right"></span></a>
                        <a href="#" className="genric-btn primary circle">Primary<span className="lnr lnr-arrow-right"></span></a>
                        <a href="#" className="genric-btn success circle">Success<span className="lnr lnr-arrow-right"></span></a>
                        <a href="#" className="genric-btn info circle">Info<span className="lnr lnr-arrow-right"></span></a>
                        <a href="#" className="genric-btn warning circle">Warning<span className="lnr lnr-arrow-right"></span></a>
                        <a href="#" className="genric-btn danger circle">Danger<span className="lnr lnr-arrow-right"></span></a>
                    </div>
                    <div className="button-group-area mt-10">
                        <a href="#" className="genric-btn default-border circle">Default<span
                                className="lnr lnr-arrow-right"></span></a>
                        <a href="#" className="genric-btn primary-border circle">Primary<span
                                className="lnr lnr-arrow-right"></span></a>
                        <a href="#" className="genric-btn success-border circle">Success<span
                                className="lnr lnr-arrow-right"></span></a>
                        <a href="#" className="genric-btn info-border circle">Info<span
                                className="lnr lnr-arrow-right"></span></a>
                        <a href="#" className="genric-btn warning-border circle">Warning<span
                                className="lnr lnr-arrow-right"></span></a>
                        <a href="#" className="genric-btn danger-border circle">Danger<span
                                className="lnr lnr-arrow-right"></span></a>
                    </div>
                    <div className="button-group-area mt-40">
				...
				<div className="container box_1170">
					<div className="section-top-border">
						...
						<div className="row">
							<div className="col-md-3">
								<img src={this.state.base_url+"assets/images/elements/d.jpg"} alt="" className="img-fluid" />
							</div>
						...
						<div className="progress-table-wrap">
							<div className="progress-table">
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/images/elements/f1.jpg"} alt="flag" />Canada</div>
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/images/elements/f2.jpg"} alt="flag" />Canada</div>
									<div className="visit">645032</div>
									<div className="percentage">
										<div className="progress">
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/images/elements/f3.jpg"} alt="flag" />Canada</div>
									<div className="visit">645032</div>
									<div className="percentage">
										<div className="progress">
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/images/elements/f4.jpg"} alt="flag" />Canada</div>
									<div className="visit">645032</div>
									<div className="percentage">
										<div className="progress">
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/images/elements/f5.jpg"} alt="flag" />Canada</div>
									<div className="visit">645032</div>
									<div className="percentage">
										<div className="progress">
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/images/elements/f6.jpg"} alt="flag" />Canada</div>
									<div className="visit">645032</div>
									<div className="percentage">
										<div className="progress">
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/images/elements/f7.jpg"} alt="flag" />Canada</div>
									<div className="visit">645032</div>
									<div className="percentage">
										<div className="progress">
								...
								<div className="table-row">
									...
									<div className="country"> <img src={this.state.base_url+"assets/images/elements/f8.jpg"} alt="flag" />Canada</div>
									<div className="visit">645032</div>
									<div className="percentage">
										<div className="progress">
					...
					<div className="section-top-border">
						...
						<div className="row gallery-item">
							<div className="col-md-4">
								<a href={this.state.base_url+"assets/images/elements/g1.jpg"} className="img-pop-up">
									<div className="single-gallery-image" style={{ background: "url("+this.state.base_url+"assets/images/elements/g1.jpg)"}}></div>
								</a>
							</div>
							<div className="col-md-4">
								<a href={this.state.base_url+"assets/images/elements/g2.jpg"} className="img-pop-up">
									<div className="single-gallery-image" style={{ background: "url("+this.state.base_url+"assets/images/elements/g2.jpg)"}}></div>
								</a>
							</div>
							<div className="col-md-4">
								<a href={this.state.base_url+"assets/images/elements/g3.jpg"} className="img-pop-up">
									<div className="single-gallery-image" style={{ background: "url("+this.state.base_url+"assets/images/elements/g3.jpg)"}}></div>
								</a>
							</div>
							<div className="col-md-6">
								<a href={this.state.base_url+"assets/images/elements/g4.jpg"} className="img-pop-up">
									<div className="single-gallery-image" style={{ background: "url("+this.state.base_url+"assets/images/elements/g4.jpg)"}}></div>
								</a>
							</div>
							<div className="col-md-6">
								<a href={this.state.base_url+"assets/images/elements/g5.jpg"} className="img-pop-up">
									<div className="single-gallery-image" style={{ background: "url("+this.state.base_url+"assets/images/elements/g5.jpg)"}}></div>
								</a>
							</div>
							<div className="col-md-4">
								<a href={this.state.base_url+"assets/images/elements/g6.jpg"} className="img-pop-up">
									<div className="single-gallery-image" style={{ background: "url("+this.state.base_url+"assets/images/elements/g6.jpg)"}}></div>
								</a>
							</div>
							<div className="col-md-4">
								<a href={this.state.base_url+"assets/images/elements/g7.jpg"} className="img-pop-up">
									<div className="single-gallery-image" style={{ background: "url("+this.state.base_url+"assets/images/elements/g7.jpg)"}}></div>
								</a>
							</div>
							<div className="col-md-4">
								<a href={this.state.base_url+"assets/images/elements/g8.jpg"} className="img-pop-up">
									<div className="single-gallery-image" style={{ background: "url("+this.state.base_url+"assets/images/elements/g8.jpg)"}}></div>
								</a>
							</div>
						</div>
					</div>
						...
						<div className="row">
							<div className="col-lg-8 col-md-8">
								...
								<form action="#">
									...
									<div className="mt-10">
										<input type="text" name="first_name" placeholder="Primary color"required
											className="single-input-primary" />
									</div>
									<div className="mt-10">
										<input type="text" name="first_name" placeholder="Accent color"required
